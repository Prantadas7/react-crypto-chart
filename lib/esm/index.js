...
var TradeViewChart = function (_a) {
    ...
    var fetchCandleData = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchCandleStickData(pair, interval, useFuturesTestnet, useSpotTestnet)];
                case 1:
                    candleData = _a.sent();
    ...
    useEffect(function () {
        var ws = new WebSocket("".concat(getWebsocketUrl(useFuturesTestnet, useSpotTestnet), "/").concat(pair.toLocaleLowerCase(), "@kline_").concat(interval));
